...
const DataContainer = ({ data, fetchData }) => {
  ...
  return (
    <div className="max-w-full mx-auto pt-2 pb-10">
          ...
          <tbody>
            {data.map((item) => {
              return (
                ...
                >
                  <td className="px-6 py-3 wrap-break-word">
                    <Link
                      to={item.fullUrl}
                      target="_blank"
                  ...
                  <td className="px-6 py-3 flex gap-5">
                    <svg
                      ...
                      stroke-width="1.5"
                      stroke="currentColor"
                      className="size-6 w-6 h-6 fill-lime-600 cursor-pointer"
                    ...
                    <svg
                      ...
                      stroke-width="1.5"
                      stroke="currentColor"
                      className="size-6 w-6 h-6 fill-red-600 cursor-pointer "
